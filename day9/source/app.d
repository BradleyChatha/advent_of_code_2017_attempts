...
unittest
{
    ...
    foreach(test; tests)
    {
        assert(groupScore(test.testStr) == test.expectedAnswer, 
               format("Expected '%s' from '%s' but got '%s'", test.expectedAnswer, test.testStr, groupScore(test.testStr)));
    }
}